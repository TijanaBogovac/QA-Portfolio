...
<p> MatchIT is a new mobile application in Serbia, which is also called Tinder for job. User swipes a job which likes and get matches with It. After matching, user gets a message via MatChat from potential employee.</p>
